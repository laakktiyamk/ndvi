 ...
 */
const calculateAutoDimensions = (geometry: any, maxWidth?: number, maxHeight?: number) => {
  try {
 ...
 */
const calculateMaxMetersPerPixel = (geometry: any) => {
  try {
    let bbox;
 ...
 */
const calculatePixelSize = (geometry: any, dimensions: number[]) => {
